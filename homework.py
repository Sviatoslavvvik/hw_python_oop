...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        spent_calories: float = ((self.COEFF_CALORIE_1 * super().get_mean_speed() - self.COEFF_CALORIE_2)
        * self.weight / self.M_IN_KM * self.duration * self.COEFF_CALORIE_3)
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        ((super().get_mean_speed() ** self.COEFF_CALORIE_2) // self.height)
